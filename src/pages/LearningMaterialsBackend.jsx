...
const LearningMaterialsBackend = () => {
  ...
  const fetchContent = async () => {
    try {
      const data = await getCourseContent("backend");
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        {/* Header Card */}
        <div className="bg-gradient-to-r from-green-600 to-teal-600 shadow-xl rounded-2xl p-8 mb-6 text-white">
...
export default LearningMaterialsBackend;